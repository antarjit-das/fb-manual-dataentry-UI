...
export function preparePayload(
  ...
  const post: Post = {
    ...
    view_count: formData.view_count !== undefined ? formData.view_count : null,
    view_count_display: formData.view_count_display,
    view_count_precision: formData.view_count_precision || "unavailable",
    reaction_count: formData.reaction_count !== undefined ? formData.reaction_count : null,
    reaction_count_display: formData.reaction_count_display,
    reaction_count_precision: formData.reaction_count_precision || "unavailable",
    like_count: formData.like_count !== undefined ? formData.like_count : null,
    like_count_display: formData.like_count_display,
    like_count_precision: formData.like_count_precision || "unavailable",
    love_count: formData.love_count !== undefined ? formData.love_count : null,
    love_count_display: formData.love_count_display,
    love_count_precision: formData.love_count_precision || "unavailable",
    haha_count: formData.haha_count !== undefined ? formData.haha_count : null,
    haha_count_display: formData.haha_count_display,
    haha_count_precision: formData.haha_count_precision || "unavailable",
    angry_count: formData.angry_count !== undefined ? formData.angry_count : null,
    angry_count_display: formData.angry_count_display,
    angry_count_precision: formData.angry_count_precision || "unavailable",
    sad_count: formData.sad_count !== undefined ? formData.sad_count : null,
    sad_count_display: formData.sad_count_display,
    sad_count_precision: formData.sad_count_precision || "unavailable",
    wow_count: formData.wow_count !== undefined ? formData.wow_count : null,
    wow_count_display: formData.wow_count_display,
    wow_count_precision: formData.wow_count_precision || "unavailable",
    care_count: formData.care_count !== undefined ? formData.care_count : null,
    care_count_display: formData.care_count_display,
    care_count_precision: formData.care_count_precision || "unavailable",
    share_count: formData.share_count !== undefined ? formData.share_count : null,
    share_count_display: formData.share_count_display,
    share_count_precision: formData.share_count_precision || "unavailable",
    comment_count: formData.comment_count !== undefined ? formData.comment_count : null,
    comment_count_display: formData.comment_count_display,
    comment_count_precision: formData.comment_count_precision || "unavailable",
  };

...
export const CODEBOOK_ROWS: string[][] = [
  ...
  ["language", "COMMENTS", "string", "No", "Assamese; English; Bengali; Hindi; Bodo; Mixed; Other", "Primary language"],
  ...
  ["comment_id", "REPLIES", "string", "Yes", "C_NNNNNN", "Foreign key to COMMENTS.comment_id"],
  ...
  ["language", "REPLIES", "string", "No", "Assamese; English; Bengali; Hindi; Bodo; Mixed; Other", "Primary language"],
